...
export default function FacturePreviewModal({
  ...
  function imprimer() {
    ...
    // (Content-Disposition: inline sur la route) — on déclenche son impression
  ...
  // lui-même appelé dans un <tbody> — un <div> positionné en <tr> serait du
  // HTML invalide (foster parenting), avec un rendu imprévisible selon les
  // navigateurs. Le portail sort le modal de l'arbre DOM du tableau tout en
  // gardant l'état React attaché à FactureRow.
  return createPortal(
    <div
